...
def move3(z):
    ...
    panel33 = Label(f3,image=photoImg1,bg='black')
...
panel1 = Label(f1,image=photoImg1,bg='black')
...
def move1(z):
    ...
    t1.destroy()
    la1.destroy()
    img11 = Image.open('sun.jpg')
    img11 = img11.resize((350,350), Image.ANTIALIAS)
...
def cal1():
    ...
    tb.config(text='Reset',command=reset)
...
s1 = Scale(f1,from_=x,to=1300,orient=HORIZONTAL, fg='white',bg='black',command=move1,font=('Georgia',15),troughcolor='white',activebackground='grey',width=25)
...
def new1():
    ...
    new.title('Centre of mass calculator')

    nc = Canvas(new,height=500,width=800,bg='#020038')
    nc.place(x=0,y=0)
    ...
    nb = Button(new, text='EXIT ', width = 10, height=3, bg='red',font=('Georgia',11),command=reopen)
    nb.place(x=650,y=400)


b5 = Button(f1,text='Centre of mass calculator',width = 20, height=3, bg='blue',fg='white',font=('Georgia',15), command=new1)
b5.place(x=1150,y=600)
b6 = Button(f2,text='Centre of mass calculator',width = 20, height=3, bg='blue',fg='white',font=('Georgia',15), command=new1)
b6.place(x=1150,y=600)
b7 = Button(f3,text='Centre of mass calculator',width = 20, height=3, bg='blue',fg='white',font=('Georgia',15), command=new1)
b7.place(x=1150,y=600)

b8 = Button(f1,text='Quit',width = 10, height=2, bg='red',fg='black',font=('Georgia',15), command=root.destroy)
b8.place(x=1200,y=700)
b8 = Button(f2,text='Quit',width = 10, height=2, bg='red',fg='black',font=('Georgia',15), command=root.destroy)
b8.place(x=1200,y=700)
b8 = Button(f3,text='Quit',width = 10, height=2, bg='red',fg='black',font=('Georgia',15), command=root.destroy)
b8.place(x=1200,y=700)
