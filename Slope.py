...
This program allows you to see how the centre of mass of object shift when the angle of inclination changes and when will the object start to slide down/topple\n\
...
def move(z):
    ...
    if a==75:
        ...
        for i in range(150):
            c2.delete(t2)
            c2.delete(line)
            t2 = c2.create_polygon(170+a+(i/3),(270-a/2)+i/2,310+(a/2)+i/3,(385-(a/9))+i/2,330+(1.4*a)+i/4,(198-(a/3))+10+i/2,fill='black')
            c2.update()
            c2.after(10)
            s1.destroy()
            l2.destroy()
            ...
            def reset():
                ...
                s1 = Scale(f2,from_=35,to=75,orient=HORIZONTAL, fg='black',command=move,bg='#347C17',font=('Georgia',15),troughcolor='#98FF98',activebackground='#617C58',width=25)
